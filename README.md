...
5. **Learning**: The system can retrain models using past transactions to improve performance.
...
Data quality checks were executed and logged successfully. Schema and null-rate checks passed, while row-count and fraud-rate checks produced warnings due to the alert-only scope of the fraud_metrics table.
